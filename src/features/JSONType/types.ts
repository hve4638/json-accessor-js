...
export type JSONTypeNames = 'string' | 'number' | 'boolean' | 'array' | 'struct' | 'replace' | 'union' | 'any' | 'null';
...
export type ReplaceJSONTypeData = {
    type: 'replace',
    replace?: JSONTree,
...
export type JSONTypeData = PrimitiveJSONTypeData | ArrayJSONTypeData | StructJSONTypeData | ReplaceJSONTypeData | UnionJSONTypeData;